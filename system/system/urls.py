...
urlpatterns = patterns('',
    ...
    url(r'^banned/', 'guides.views.list_banned'), # list people
    url(r'^add-banned/', AddBannedPerson.as_view(), name='add_banned_person'), # add a person
    ...
    url(r'^unban/(?P<slug>\d+)/$', UnbanPerson.as_view(), name='unban_person'),
